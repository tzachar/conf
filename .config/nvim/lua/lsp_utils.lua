...
function M.on_attach(client, bufnr)
  ...
  buf_set_keymap('n', 'dp', '<cmd>lua vim.diagnostic.jump({count = -1, float = false, severity = { min = vim.diagnostic.severity.INFO }})<CR>', opts)
  buf_set_keymap('n', 'dn', '<cmd>lua vim.diagnostic.jump({count = 1, float = false, severity = { min = vim.diagnostic.severity.INFO }})<CR>', opts)
